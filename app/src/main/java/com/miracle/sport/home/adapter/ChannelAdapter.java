    ...
    protected void convert(final BaseViewHolder helper, final Channel channel) {
        switch (helper.getItemViewType()) {
            case Channel.TYPE_MY:
                ...
                helper.setText(R.id.tvTitle, channel.name)
            ...
            case Channel.TYPE_MY_CHANNEL:
                ...
                helper.setText(R.id.tvChannel, channel.name).setOnClickListener(R.id.ivDelete, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //执行删除，移动到推荐频道列表
                        if (mIsEdit) {
...
//                            GlobalParams.mRemovedChannels.add(channel);
            ...
            case Channel.TYPE_OTHER_CHANNEL:
                //频道推荐列表
                helper.setText(R.id.tvChannel, channel.name).setVisible(R.id.ivDelete, false)
    ...
    private void startEditMode(boolean isEdit) {
        ...
        for (int i = 0; i < visibleChildCount; i++) {
            ...
            if (imgEdit != null) {
                ...
                imgEdit.setVisibility(isVis && isEdit && !mData.get(i).name.equals("推荐") ? View.VISIBLE : View.INVISIBLE);
            }
        }
    }
}
