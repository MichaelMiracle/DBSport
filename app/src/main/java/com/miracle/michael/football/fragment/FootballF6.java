...
import com.miracle.databinding.F6FootballBinding;

/**
 * 扇形我的
 * Created by Michael on 2018/10/15 10:15 (星期一)
 */
public class FootballF6 extends BaseFragment<F6FootballBinding> {
    ...
    public FootballF6 setDrawer(DrawerLayout drawerLayout) {
