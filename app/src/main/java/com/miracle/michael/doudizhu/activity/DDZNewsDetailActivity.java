...
public class DDZNewsDetailActivity extends BaseActivity<ActivitySimpleWebBinding> {
    ...
    private void reqData() {
        ZClient.getService(ZService.class).getDDZNewsDetail(id).enqueue(new ZCallback<ZResponse<NewsDetailBean>>(binding.swipeRefreshLayout) {
            @Override
