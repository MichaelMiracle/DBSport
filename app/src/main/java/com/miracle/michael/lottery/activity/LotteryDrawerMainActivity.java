...
public class LotteryDrawerMainActivity extends BaseActivity<ActivityLotteryDrawerBinding> {
    ...
    private DrawerItemBean[] drawerItems = {new DrawerItemBean( CommonUtils.getString(R.string.icon_tab_home), "快讯"),
            new DrawerItemBean( CommonUtils.getString(R.string.icon_tab_category), "分类"),
            new DrawerItemBean( CommonUtils.getString(R.string.icon_trend_map), "走势图"),
            new DrawerItemBean( CommonUtils.getString(R.string.icon_chatroom), "聊天室"),
            new DrawerItemBean( CommonUtils.getString(R.string.icon_tab_me), "我的"),
    };
    ...
    public void initView() {
        ...
        fragment1 = new LotteryF1().setDrawer(binding.drawerLayout);
        fragment2 = new LotteryF3().setDrawer(binding.drawerLayout);
        fragment3 = new LotteryF7().setDrawer(binding.drawerLayout);
        fragment4 = new LotteryF7();
        fragment5 = new LotteryF5().setDrawer(binding.drawerLayout);
