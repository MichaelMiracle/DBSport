...
//        binding.webView.loadUrl(mUrl);
    ...
    private void reqData() {
        ZClient.getService(ZService.class).getChessNewsDetail(id).enqueue(new ZCallback<ZResponse<ChessNewsDetailBean>>() {
            @Override
            public void onSuccess(ZResponse<ChessNewsDetailBean> data) {
