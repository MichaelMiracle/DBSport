 ...
 */
public class ChessDrawerMainActivity extends BaseActivity<ActivityFootballDrawerBinding> {
    ...
    private DrawerItemBean[] drawerItems = {new DrawerItemBean( CommonUtils.getString(R.string.icon_tab_home), "快讯"),
            new DrawerItemBean( CommonUtils.getString(R.string.icon_tab_auction), "分类"),
    ...
    public void initView() {
        ...
        fragment1 = new ChessF1().setDrawer(binding.drawerLayout);
//        fragment2 = new FootballF5().setDrawer(binding.drawerLayout);
        fragment3 = new ChessF2().setDrawer(binding.drawerLayout);
